    ...
    return (
        <div>
            <section className="dark:bg-gray-800 dark:text-gray-100  ">
             ...
             {
                servicesx.slice(0,3).map(services=><div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
              ...
              Available
                ...
                <div>
                    <img src={services.picture} alt="" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
                    <h2 className="mb-1 text-xl font-semibold">{services.place_name}</h2>
                    <p className="text-sm dark:text-gray-400">{services.details.substring(0, 150)}...</p>
                </div>
                <div className="flex flex-wrap justify-between">
                    <div className="space-x-2">
                        <button aria-label="Share this post" type="button" className="p-2 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-teal-400">
