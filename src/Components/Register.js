...
const Register = () => {
  ...
  const handleGithubSignin=()=>{
    ...
    return (
        <div className='dark:bg-gray-800 dark:text-gray-100 flex justify-center items-center pt-8 py-8'>
          
      <div className='dark:bg-slate-300 flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
